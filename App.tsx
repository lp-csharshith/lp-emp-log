    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
        ...
        {!submitted ? (
          <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="mb-10 text-center">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight mb-3">Daily Status Entry</h2>
              <p className="text-slate-500 font-medium">Real-time status tracking with automated overtime detection. Your entry will be recorded in the LP Performance database.</p>
            </div>
          ...
          <div className="max-w-2xl mx-auto mt-20 p-12 bg-white rounded-[3rem] shadow-2xl shadow-slate-200/50 border border-slate-100 text-center animate-in zoom-in-95 duration-500">
            ...
            <h2 className="text-3xl font-black text-slate-900 mb-4 tracking-tight">Status Submitted</h2>
            <p className="text-slate-500 mb-10 font-medium">Your daily performance log has been securely transmitted to the LP Performance Organization central database.</p>
            <button 
      ...
      <footer className="py-12 text-center opacity-40">
        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">
          LP PERFORMANCE ORGANIZATION &bull; DAILY STATUS TERMINAL
        </p>
      </footer>
    </div>
  );
